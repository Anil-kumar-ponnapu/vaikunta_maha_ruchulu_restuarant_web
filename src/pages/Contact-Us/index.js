...
import { FaceBookIcon, InstagramIcon, TwiterIcon, Youtube } from "../../components/Icons";
...
const ContactUs = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true)
        emailjs
            .sendForm('service_ezg46gf', 'template_k55exoh', form.current, {
                    ...
                    <div className="contact-info-container">
                        <div className="section">
                            ...
                            <div className="info-item">
                                ...
                                >
                                    Dr No: 50-121-60/1A, 4th Town Police Station Road,
                                    <br /> Balayya Sastry Layout, <br /> Seethammadhara,
