                    ...
                    <div className="about-text-overlay">
                        <section className="about-section">
                            ...
                            <p className="about-paragraph">
                                At Vaikunta Maha Ruchulu Restaurant we honor Andhra’s vegetarian heritage with every meal. Our founder Anil grew up helping his grandmother grind spices. Today, we bring those same flavors to Vizag—sourced from local farmers and cooked with zero onion/garlic<br /><br />
                            ...
                            <p className="about-paragraph">
                                At Vaikunta Maha Ruchulu Restaurant "Field to Fork" isn't just a catchy phrase - it's our unwavering promise. It means we're deeply committed to sourcing the freshest, highest-quality ingredients directly from local farms and trusted growers.<br /><br />
